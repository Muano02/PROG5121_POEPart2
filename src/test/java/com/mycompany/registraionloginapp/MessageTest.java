...
public class MessageTest {
    ...
    public void testMessageLength_Success() {
        ...
        assertTrue(validMessage.length() <= 250, "Message length should be <= 250.");
    }
    ...
    public void testMessageLength_Failure() {
        ...
        assertTrue(tooLongMessage.length() > 250, "Message length should be > 250.");
    }
    ...
    public void testRecipientNumber_Success() {
        ...
        assertTrue(message1.checkRecipientCell(), "Recipient number should be correctly formatted (SA international).");
    }
    ...
    public void testRecipientNumber_Failure() {
        ...
        assertFalse(message2.checkRecipientCell(), "Recipient number should be incorrectly formatted for SA international.");
    ...
    //     // Verify content of loaded messages. You might need to adjust this
    //     // if Message doesn't have proper equals/hashCode or if the ID is generated
    //     // during deserialization in a way that makes direct equality tricky.
    //     // A common approach is to compare key properties.
